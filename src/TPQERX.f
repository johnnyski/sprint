...
C  324   TAPE LOGICAL UNIT NUMBER MUST BE SPECIFIED                    OUTFIL
...
324   CONTINUE
      PRINT 424
424   FORMAT(/1X,'+++  TAPE LOGICAL UNIT NUMBER MUST ',
     X          'BE SPECIFIED  +++'/)
      GO TO 700
C
325   CONTINUE
...
328   CONTINUE
      PRINT 428
428   FORMAT(/1X,'+++  INPUT VELOCITY VALUES OUTSIDE ',
     X          'THE NYQUIST RANGE-  +++'/)
      PRINT 528
528   FORMAT(/1X,'+++   UNFOLDING CANNOT BE PERFORMED',
     X          '                    +++'/)
      GO TO 700
  329 CONTINUE
      PRINT 429
